...
c.aliases = {
        ...
        'red': 'open https://reddit.com',
        'trans': 'open http://www.sanakirja.org',
        'git': 'open https://github.com'
        }
#c.aliases['you']  =  'open https://youtube.com' tekee saman mitä ylempänä 
...
'g' : 'https://google.fi/search?hl=en&q={}',
'r' : 'https://reddit.com/r/{}',
'git' : 'https://github.com/search?q={}',
'ke' : 'http://sanakirja.org/search.php?q={}&l=3&l2=17',
'ks' : 'http://sanakirja.org/search.php?q={}&l=17&l2=3'
}
...
#Omia bindejä
#config.bind(';k', 'set storage download-directory "~/kuvat" ;; hint links download')
# config.bind(';d', 'hint links download')
